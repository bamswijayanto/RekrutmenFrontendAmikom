...
<div class="card-body">
<p>Tugas 2 | Akuntansi | Wijayanto, S.Kom </p><p class="text-danger">Deadline: 19/07/2021 17:00 WIB</p>
</div>
</div>

<div class="card ctm-border-radius shadow-sm grow">
<div class="card-header">
<h4 class="card-title doc d-inline-block mb-0">Silahkan Upload:</h4>
<a href="javascript:void(0)" class="float-right doc-fold text-primary d-inline-block text-info" data-toggle="modal" data-target="#add-document"><i class="mr-3 fa fa-plus"></i>Add Document</a>
</div>
...
<div class="row">
	<div class="col-12">
		<div class="document-up">
			<a href="javascript:void(0)"><i class="mr-2 text-primary fa fa-file-pdf-o" aria-hidden="true"></i> Tugas2_Bambang.pdf <span class="float-right text-primary" data-toggle="modal" data-target="#upload-document">Edit</span></a>
		</div>
	</div>
</div>
...
<div class="card flex-fill ctm-border-radius shadow-sm grow">
	<div class="card-header">
		<h4 class="card-title mb-0">Beri Komentar</h4>
	</div>
	<div class="card-body text-center">
		<p class="card-text mb-3"><span class="text-primary">Semoga nilainya memuaskan Aamiin</p>
...
<div class="add-doc text-center">
	<a href="javascript:void(0)" data-toggle="modal" data-target="#add-document" class="btn btn-theme button-1 ctm-border-radius text-white text-center">Submit</a>
</div>
