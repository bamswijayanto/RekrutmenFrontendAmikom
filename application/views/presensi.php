            ...
            <div class="card-body">
              <div class="row no-gutters">
                ...
                <div class="col-6 align-items-center shadow-none text-center">
                  <a href="presensi" class="text-white active p-4 ctm-border-right ctm-border-left"><span class="lnr lnr-calendar-full pr-0 pb-lg-2 font-23"></span><span class="">Presensi</span></a>
                </div>
                <div class="col-6 align-items-center shadow-none text-center">
        ...
        <div class="card ctm-border-radius shadow-sm grow">
          <div class="card-body">
            <div style="margin-top: -75px">	
              <a href="javascript:void(0)" class="btn btn-theme button-1 ctm-border-radius text-white btn-block" data-toggle="modal" data-target="#add_event" style="position: relative; top: 82px; left: 125px; z-index: 3; width: 18%"><span><i class="fa fa-plus"></i></span> &nbsp; Presensi</a>
              <img src="<?= base_url() ?>assets/img/Capture3.PNG" width="90" style="position: relative; top: 40px; left: 105px; z-index: 2">
              <div id="calendar"></div>
              <p class="text-center mt-3"> Total Absensi: 245 | Total Ijin: 15 | Tanpa Keterangan: 5</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-body">
      ...
      <form>
        <div class="form-group">
          ...
          <div class="cal-icon">
            <input class="form-control datetimepicker" type="text" placeholder="19/07/2021" >
        ...
        <div class="form-group">
          ...
          <select class="form-control select" name="category">
            <option value="bg-success">Hadir</option>
            <option value="bg-danger">Ijin</option>
          </select>
        </div>
        <div class="form-group">
