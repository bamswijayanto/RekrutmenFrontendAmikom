			...
			<div class="row">
				<div class="col-md-6 d-flex">
					<div class="card ctm-border-radius shadow-sm company-logo flex-fill grow ">
						<div class="card-header">
							<h4 class="card-title mb-0">Foto Profil</h4>
						</div>
						<div class="card-body">
							<form>
								<div class="row">
									<div class="col-12">
										<div class="avatar-upload">
											...
											<div class="avatar-preview" style="width: 180px">
												<div id="imagePreview">
													<img src="<?= base_url() ?>assets/img/Capture2.JPG" width="160">
												</div>
											</div>
										</div>
									</div>
				...
				<div class="col-md-6 d-flex">
					<div class="card ctm-border-radius shadow-sm flex-fill grow">
						...
						<div class="card-body">
							<p class="card-text mb-3"><span class="text-primary">Nama Depan :</span> Bambang</p>
							<p class="card-text mb-3"><span class="text-primary">Nama Belakang : </span>Wijayanto</p>
							<p class="card-text mb-3"><span class="text-primary">Kewarganegaraan :</span> Indonesia</p>
							<p class="card-text mb-3"><span class="text-primary">Tanggal Lahir :</span> 20 Mei 2000</p>
							<p class="card-text mb-3"><span class="text-primary">Gol. Darah :</span> O</p>
