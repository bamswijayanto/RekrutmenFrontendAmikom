...
<div class="card-body">
	<p>Kuis 1 | Sistem Pakar | Bambang, S.Kom </p><p class="text-danger">Deadline: 19/07/2021 17:00 WIB</p>
</div>
</div>
...
<div class="col-md-7 d-flex">
	<div class="card ctm-border-radius shadow-sm grow flex-fill">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-md-8">
					<p><span class="">Apa pengertian foward chaining? : </span></p>

					<div class="form-check">
						<input class="form-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
						<label class="form-check-label" for="flexRadioDefault1">
							A. Salah Satu Metode Sistem Pakar
						</label>
					</div>
					<div class="form-check">
						<input class="form-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked>
						<label class="form-check-label" for="flexRadioDefault2">
							B. Salah Satu Rumus Matematika
						</label>
					</div>
					<div class="form-check">
						<input class="form-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked>
						<label class="form-check-label" for="flexRadioDefault2">
							C. Salah Satu Algoritma 
						</label>
					</div>
				</div>
...
<div class="col-md-5 d-flex">
	<div class="card ctm-border-radius shadow-sm grow flex-fill">
		...
		<div class="card-body">
			...
			<div class="row align-items-center" >
				<div class="col">
					<h5 class="btn btn-theme text-white mt-3"><b>1</b></h5>
				</div>
				<div class="col">
					<a href="manage2.html"><h5 class="btn btn-outline-primary mt-3"><b>2</b></h5></a>
				</div>
				<div class="col">
					<h5 class="btn btn-outline-primary mt-3"><b>3</b></h5>
				</div>    
				<div class="col">
