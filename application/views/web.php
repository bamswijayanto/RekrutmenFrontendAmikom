...
<div class="card-body">
<p>Responsi | Pemograman Web | Nindi, M.Kom </p><p class="text-danger">Deadline: 19/07/2021 17:00 WIB</p>
</div>
</div>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-8">
				...
				<p><span class="">Jelaskan kepada bumi bulat: </span></p>

				<textarea class="form-input" type="checkbox" name="flexRadioDefault" id="flexRadioDefault1" placeholder="ketik min 500 kata">
				</textarea>
...
<div class="card ctm-border-radius shadow-sm grow flex-fill">
	...
	<div class="card-body">
		...
		<div class="row align-items-center" >
			...
			<div class="col">
				<h5 class="btn  btn-outline-primary mt-3"><b>2</b></h5>
			</div>
			<div class="col">
				<h5 class="btn btn-theme text-white mt-3"><b>3</b></h5>
			</div>    
			<div class="col">
